...
myWin = visual.Window(color='orange', units='pix', size=[2000,1000], allowGUI=False, fullscr=False)#creates a window 
...
box1 =visual.Rect(myWin, pos=[-200,0], width=20, height=20, lineWidth=3, lineColor=[1,1,0], fillColor=[1,1,0])
box2 =visual.Rect(myWin, pos=[0,-150], width=20, height=20, lineWidth=3, lineColor=[0,1,1], fillColor=[0,1,1])
box3 =visual.Rect(myWin, pos=[200,-300],width=20, height=20, lineWidth=3, lineColor=[1,0,1], fillColor=[1,0,1])
...
def mainLoop():
    ...
    frame2.setWidth(b*10)
    frame2.setHeight(b*5)
    frame3.setWidth(b*2)
